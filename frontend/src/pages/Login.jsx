  ...
  return (
    <div className="card p-6 h-screen flex gap-4 flex-col items-center justify-center">
      ...
      <Card className="w-[300px] sm:w-[400px]">
        <CardHeader>
          <CardTitle className="mx-auto text-xl text-primary">Login Now</CardTitle>
        </CardHeader>
        <CardContent>
          <form>
        ...
        <p className="text-center pb-4 text-primary" onClick={()=>navigate("/helper-login")}>Registered Helper? Login here</p>
      </Card>
    </div>
  );
}
